...
use Logstats\Services\Installation\InstallationService;
...
class InstallationServiceTest extends TestCase{
	...
	public function test_setNextInstallationStep() {
		list($laravelConfig,$envConfig,$str,$steps) = $this->getMocks();
		$installationService = $this->getMock(Logstats\Services\Installation\InstallationService::class,
	...
	private function getMocks() {
		return [
			...
			Mockery::mock('Logstats\Services\Installation\StepCollection'),
		];
	}
}